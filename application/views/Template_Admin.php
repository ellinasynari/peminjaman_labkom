...
<html lang="en">
  ...
  <head>
    ...
    <title>Peminjaman Labkom - Assyifa Wanareja</title>
      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="navbar nav_title" style="border: 0;">
              ...
              <a href="<?php echo base_url() ?>admin" class="site_title">
                <img width="50px" height="50px" src="<?php echo base_url() ?>assets/img/logo/logo-aswaja.png">
              </a>
            ...
            <nav>
             ...
             <!--  <div class="nav toggle">
              ...
              <!-- <ul class="nav navbar-nav navbar-left">
                ...
                <li class="">
                  <label>Sistem Informasi Peminjaman Labkom</label>
                </li>
              ...
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                    ...
                    <h3> Sistem Informasi Peminjaman Labkom <small></small></h3>
        ...
        <footer>
          <div class="pull-right">
             <p>© 2024: Peminjaman Labkom <a  href="https://smait-wanareja.assyifa-boardingschool.sch.id/">SMAIT Assyifa Boarding School Wanareja<br></a></p>
          </div>
          <div class="clearfix"></div>
        </footer>
