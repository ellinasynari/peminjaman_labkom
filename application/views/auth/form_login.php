...
<body class="login-page sidebar-collapse">
  ...
  <div class="page-header clear-filter" filter-color="orange">
    <div class="page-header-image" style="background-image:url(<?php echo base_url(); ?>/assets/login/assets/img/foto-bg.jpg)"></div>
    <div class="content">
      <div class="container">
            ...
            <form class="form" method="POST" action="<?php echo base_url() ?>auth/login" >
              ...
              <h4>Login Form</h4>
                <div class="input-group no-border input-lg">
                  ...
                  <input type="text" class="form-control" placeholder="NIS/NIP/Username" required="" id="username" name="user">
                </div>
                <div class="input-group no-border input-lg">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
    ...
    <!--             <div class="input-group no-border input-lg">
                  ...
                  <select class="form-control">
                    <option class="form-control"> Mahasiswa</option>
                    <option class="form-control">Dosen</option>
                  </select>
                </div> -->
              
              <div class="card-footer text-center">
                <input type="submit" name="login" value="Login" class="btn btn-primary btn-round btn-lg btn-block" />
                <div class="pull-left">
                  <h6>
                    <a href="<?php echo base_url(); ?>auth/signup" class="link">Create Account</a>
                  </h6>
              </div>
              <div class="pull-right">
                  <h6>
                    <a href="<?php echo base_url() ?>auth/Forget_Password" class="link">Forget Password ?</a>
                  </h6>
                </div>
            </form>
            </div>
