            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel ">
                  ...
                  <div class="x_title">
                  	<div class="a">
                    <center><u style="font-family: Monaco, Verdana, Sans-serif;"><strong>SURAT PERMOHONAN Peminjaman Labkom</strong></u></center>
                    </div>
                  ...
                  <div class="x_content" >
                      <div class="profile_img">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 c ">
                            <p>Bersama ini kami mohon Peminjaman Labkom di SMAIT Assyifa Boarding School Wanareja pada:</p>
                            <table>
                            	<tr>
                            		<td>Hari</td>
                            		<td> :</td>
                          ...
                          <div class="pull-right" style="margin-right: 80px;">
                          	...
                          	<p>NIS/NIP. <?php echo $row[0]->NIM_NIP ; ?> </p>
                          </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel ">
                  ...
                  <div class="x_title">
                    ...
                    <img src="<?php echo base_url() ?>assets/img/logo/logo-aswaja.png" width="100px">
                    </div>
                    <div class="col-md-9 col-sm-9 col-xs-9 a" >
                      ...
                      <p>Secretariat: Physics Department, Graduate Program, <br>
                      	...
                      	Telpon. (0271) 637457 Fax. (0271) 637457 Website. https://smait-wanareja.assyifa-boardingschool.sch.id/ <br>
                  ...
                  <div class="x_content" >
                      <div class="profile_img">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="col-md-12 col-sm-12 col-xs-12 c">
                            <p>Yth. Penanggungjawab Ruang <strong><?php echo $row[0]->nama_ruang ?></strong></p>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-4">
                            <!-- <p>Subject : Letter of Acceptance</p> -->
                            <!-- <p>March 31st, 2018
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 c ">
                            <p>Mohon dapat dilayani penggunaan ruang besok pada:</p>
                            <table>
                            	<tr>
                            		<td>Hari</td>
                            		<td> :</td>
