...
<html lang="en">
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>assets/img/logo/logo_aswaja.png">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>assets/img/logo-aswaja.png">
      ...
      <div class="main_container">
           <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>Peminjaman Labkom <small>SMAIT Assyifa Boarding School Wanareja</small></h3>
                  ...
                  <div class="x_content">
                    ...
                    <footer>
                      <div class="pull-right">
                        <a href=""> SMAIT Assyifa Boarding School Wanareja</a>
                      </div>
                      <div class="clearfix"></div>
                    </footer>
</div>  
